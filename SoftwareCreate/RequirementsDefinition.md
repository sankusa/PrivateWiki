...
> ### 機能要件
> [(参考)要件定義における成果物一覧と書き方（要件定義書サンプルあり）](https://pm-rasinban.com/rd-write)  
> 1.業務要件  
> 1-1.システム化の目的・背景・狙い
> - 目的  
...
>     - （例）現行システムは構築から8年が経過し新たな業務への対応が困難であり、それを手作業で補っているため事務のミスが増加している。
>     - （例）新業務に関する事務の比率が増加しており、今後さらに事務負担の増大が予想される。
>     - （例）現行システムのインフラの多くは既にサポート期間が終了しており、維持管理上の深刻な課題となっている。
> - 狙い
>   - システム構築によってどのような効果を期待しているのか。
>     - （例）システム化が未着手の○○業務への対応による効率化
>     - （例）上記の○○業務システムと基幹システムとのデータ連携
>     - （例）手作業によるデータ・チェック作業の自動化による人為ミスの減少
> - 
> 1-2.ビジネスプロセス関連図  
> 1-3.業務機能構成表  
> 1-4.ビジネスプロセスフロー  
